...
Personal AI assistant ("Jarvis") connected to Slack via `clay_chat`. Responds to direct messages and @mentions in channels, with tools for web search, URL summarisation, and date/time lookups, plus workflows for daily briefs and research summarisation.
...
- [clay-chat](../../../packages/chat/README.md) — Slack integration details
