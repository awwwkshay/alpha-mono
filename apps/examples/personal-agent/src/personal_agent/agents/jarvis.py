...
from clay_app import Agent
from clay_chat import SlackChat, TelegramChat
...
personal_agent_config = AGENT
personal_agent = Agent(config=AGENT)

__all__ = ["AGENT", "personal_agent_config", "personal_agent"]
